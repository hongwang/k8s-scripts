...
class KubeConfig:
    ...
    def __init__(self):
        ...
        # changed start >>
        self.dags_volume_mountpath = conf.get(self.kubernetes_section, 'dags_volume_mountpath')
        self.workspaces_volume_mountpath = conf.get(self.kubernetes_section, 'workspaces_volume_mountpath')
        # << changed end
